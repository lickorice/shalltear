...
MSG_PLOT_PRICE_CHECK = "{0.mention}, your next **{2}** plots costs **💵 {1} gil**."
MSG_PLOT_BUY_SUCCESS = "{0.mention}, you have successfully bought **{2}** new plots! Your new balance is now **💵 {1} gil**."
...
MSG_SILO_PRICE_CHECK = "{0.mention}, your next **{2}** silos costs **💵 {1} gil**. Each new silo upgrades your crop storage by 100."
