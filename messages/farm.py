...
MSG_PLOT_BUY_SUCCESS = "{0.mention}, you have successfully bought a new plot! Your new balance is now **💵 {1:.2f} gil**."
...
MSG_SILO_PRICE_CHECK = "{0.mention}, your next silo costs **💵 {1:.2f} gil**. Each new silo upgrades your crop storage by 100."
MSG_SILO_BUY_SUCCESS = "{0.mention}, you have successfully bought a new silo! Your new balance is now **💵 {1:.2f} gil**."